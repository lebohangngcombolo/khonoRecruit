class ApiEndpoints {
  ...
  // Shared Notes
  static const createNote = "$adminBase/notes/create";
  static const getNotes = "$adminBase/notes";
  static const getNoteById = "$adminBase/notes";
  static const updateNote = "$adminBase/notes/update";
  static const deleteNote = "$adminBase/notes/delete";
  static const shareNote = "$adminBase/notes/share";

  // Meetings
  static const createMeeting = "$adminBase/meetings/create";
  static const getMeetings = "$adminBase/meetings";
  static const getMeetingById = "$adminBase/meetings";
  static const updateMeeting = "$adminBase/meetings/update";
  static const deleteMeeting = "$adminBase/meetings/delete";
  static const inviteToMeeting = "$adminBase/meetings/invite";
