  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: loading
            ? const Center(child: CircularProgressIndicator(color: Color(0xFFC10D00)))
            : drafts.isEmpty
                ? Center(
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        const Icon(Icons.save_outlined, size: 72, color: Colors.white70),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ElevatedButton(
                                    onPressed: syncing ? null : () => _syncSingle(d),
                                    style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFFC10D00)),
                                    child: Text('Sync Now', style: GoogleFonts.poppins(fontWeight: FontWeight.w600, color: Colors.white)),
                                  ),
                                  ...
                                  OutlinedButton(
                                    ...
                                    child: Text('Continue', style: GoogleFonts.poppins(fontWeight: FontWeight.w600, color: Colors.white)),
                                  ),
                                  const SizedBox(width: 8),
                                  TextButton(
