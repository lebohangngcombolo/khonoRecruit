...
class _AssessmentPageState extends State<AssessmentPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (questions.isEmpty) {
      return Scaffold(
        appBar: AppBar(
            title: Text("Assessment", style: GoogleFonts.poppins(fontWeight: FontWeight.w600, color: Colors.white)), backgroundColor: Colors.red),
        body: Container(
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage('assets/images/Frame 1.jpg'),
    ...
    return Scaffold(
      appBar:
          AppBar(title: Text("Assessment", style: GoogleFonts.poppins(fontWeight: FontWeight.w600, color: Colors.white)), backgroundColor: Colors.red),
      body: Container(
        decoration: const BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/images/Frame 1.jpg'),
