...
class _ProfilePageState extends State<ProfilePage>
  ...
  Widget _outlineSwitch({required bool value, required ValueChanged<bool> onChanged}) {
  ...
  Widget _buildSettingsTab() {
    return SingleChildScrollView(
      ...
      child: _bannerCard(
        ...
        Column(
          children: [
            _toggleRow("Dark Mode", darkMode, (v) => setState(() => darkMode = v)),
            _toggleRow("Notifications", notificationsEnabled, (v) => setState(() => notificationsEnabled = v)),
            _toggleRow("Job Alerts", jobAlertsEnabled, (v) => setState(() => jobAlertsEnabled = v)),
            _toggleRow("Profile Visible", profileVisible, (v) => setState(() => profileVisible = v)),
            _toggleRow("Enrollment Completed", enrollmentCompleted, (v) => setState(() => enrollmentCompleted = v)),
            const SizedBox(height: 12),
            ElevatedButton(
        ...
        Column(
          children: [
            ...
            ElevatedButton(
              ...
              style:
                  ElevatedButton.styleFrom(backgroundColor: const Color(0xFFC10D00)),
              child: isLoading
                  ? const SizedBox(
                      height: 20,
                      width: 20,
