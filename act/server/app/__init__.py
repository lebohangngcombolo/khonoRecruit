...
from .models import *
from .routes import auth, admin_routes, candidate_routes, ai_routes, mfa_routes  # 🆕 Import mfa_routes
...
def create_app():
    ...
    app.register_blueprint(mfa_routes.mfa_bp, url_prefix="/api/auth")  # 🆕 Register MFA blueprint like others
